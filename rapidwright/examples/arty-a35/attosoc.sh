#!/usr/bin/env bash
set -ex
yosys -p "synth_xilinx -flatten -nobram -nocarry -arch xcup -top top; write_json attosoc.json" ../attosoc/attosoc.v attosoc_top.v
../../../nextpnr-rapidwright --chipdb ../../xc7a35t.bin --xdc arty.xdc --json attosoc.json --write attosoc_routed.json --fasm attosoc.fasm

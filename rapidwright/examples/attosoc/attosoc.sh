...
../../../nextpnr-rapidwright --chipdb ../../xczu2cg.bin --json attosoc.json --write attosoc_routed.json
...
iverilog -o attosoc_tb attosoc_tb.v attosoc_out.v ramd64e_sim.v -y${XILINX_VIVADO}/data/verilog/src/unisims ${XILINX_VIVADO}/data/verilog/src/glbl.v
./attosoc_tb

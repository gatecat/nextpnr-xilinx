...
${XRAY_TOOLS_DIR}/xc7frames2bit --part_file ${XRAY_UTILS_DIR}/../database/zynq7/xc7z020clg400-1.yaml --part_name xc7z020clg400-1 --frm_file blinky.frames --output_file blinky.bit
